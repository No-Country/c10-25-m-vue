...
<div class="radio-group">
  ...
  <label for="mascota1">Terry</label>
          ...
          <div class="row " v-else>
                ...
                <div  
                class="" :class="showSexSelect ? 'open-select ' : 'select_options'" @click="toggleSexSelect">
                  <span class="selectStatic">{{ selectedSexOption }}</span>
                  <img :src="!arrowSex_close ? '../../src/assets/appoinment_img/arrow_baja.svg' : '../../src/assets/appoinment_img/arrow_sube.svg'" alt="">
                </div>
                ...
                <div class="column">
                  ...
                  <div :class="showSelect ? 'open-select ' : 'select_options'"  @click="toggleSelect">
                    ...
                    <img :src="!arrow_close ? '../../src/assets/appoinment_img/arrow_baja.svg' : '../../src/assets/appoinment_img/arrow_sube.svg'" alt="">
                    </div>
